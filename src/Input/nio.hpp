...
template <typename JeeIType> void buildJeeI(JeeIType &JeeI, double rcut) {
  ...
  { // add uuNi
    std::vector<RealType> Y = {
        -0.003356164484, 0.002412623253,  0.01653623839,  0.0008341346169,
  ...
  { // add udNi
    std::vector<RealType> Y = {
        -0.006861627197, 0.003278047306,  0.03324006545,   0.003097361067,
  ...
  { // add uuO
    std::vector<RealType> Y = {
        -0.003775082438,  -0.00169971229,   0.02162925441,   0.005674020544,
  ...
  { // add udO
    std::vector<RealType> Y = {
        -0.009590393593, 0.002498010871, 0.04225872633,  0.00460311261,
