...
struct OTDot<Tensor<T1, D>, TinyVector<T2, D>> {
  ...
  inline static TinyVector<Type_t, D> apply(const Tensor<T1, D> &lhs,
...
template <class T1, class T2> struct OTDot<Tensor<T1, 1>, TinyVector<T2, 1>> {
  typedef typename BinaryReturn<T1, T2, OpMultiply>::Type_t Type_t;
  inline static TinyVector<Type_t, 1> apply(const Tensor<T1, 1> &lhs,
                                            const TinyVector<T2, 1> &rhs) {
    return TinyVector<Type_t, 1>(lhs[0] * rhs[0]);
  }
};

template <class T1, class T2> struct OTDot<Tensor<T1, 2>, TinyVector<T2, 2>> {
  typedef typename BinaryReturn<T1, T2, OpMultiply>::Type_t Type_t;
  inline static TinyVector<Type_t, 2> apply(const Tensor<T1, 2> &lhs,
...
template <class T1, class T2> struct OTDot<Tensor<T1, 3>, TinyVector<T2, 3>> {
  typedef typename BinaryReturn<T1, T2, OpMultiply>::Type_t Type_t;
  inline static TinyVector<Type_t, 3> apply(const Tensor<T1, 3> &lhs,
                                            const TinyVector<T2, 3> &rhs) {
    return TinyVector<Type_t, 3>(
...
template <class T1, class T2> struct OTDot<Tensor<T1, 4>, TinyVector<T2, 4>> {
  typedef typename BinaryReturn<T1, T2, OpMultiply>::Type_t Type_t;
  inline static TinyVector<Type_t, 4> apply(const Tensor<T1, 4> &lhs,
                                            const TinyVector<T2, 4> &rhs) {
    return TinyVector<Type_t, 4>(
...
struct OTDot<TinyVector<T1, D>, Tensor<T2, D>> {
  typedef typename BinaryReturn<T1, T2, OpMultiply>::Type_t Type_t;
  inline static TinyVector<Type_t, D> apply(const TinyVector<T2, D> &lhs,
                                            const Tensor<T1, D> &rhs) {
    TinyVector<Type_t, D> ret = TinyVector<Type_t, D>::DontInitialize();
    for (unsigned int i = 0; i < D; ++i) {
...
template <class T1, class T2> struct OTDot<TinyVector<T1, 1>, Tensor<T2, 1>> {
  typedef typename BinaryReturn<T1, T2, OpMultiply>::Type_t Type_t;
  inline static TinyVector<Type_t, 1> apply(const TinyVector<T1, 1> &lhs,
                                            const Tensor<T2, 1> &rhs) {
    return TinyVector<Type_t, 1>(lhs[0] * rhs[0]);
  }
};

template <class T1, class T2> struct OTDot<TinyVector<T1, 2>, Tensor<T2, 2>> {
  typedef typename BinaryReturn<T1, T2, OpMultiply>::Type_t Type_t;
  inline static TinyVector<Type_t, 2> apply(const TinyVector<T1, 2> &lhs,
...
template <class T1, class T2> struct OTDot<TinyVector<T1, 3>, Tensor<T2, 3>> {
  typedef typename BinaryReturn<T1, T2, OpMultiply>::Type_t Type_t;
  inline static TinyVector<Type_t, 3> apply(const TinyVector<T1, 3> &lhs,
...
template <class T1, class T2> struct OTDot<TinyVector<T1, 4>, Tensor<T2, 4>> {
  typedef typename BinaryReturn<T1, T2, OpMultiply>::Type_t Type_t;
  inline static TinyVector<Type_t, 4> apply(const TinyVector<T1, 4> &lhs,
...
struct OuterProduct<TinyVector<T1, D>, TinyVector<T2, D>> {
  ...
  inline static Return_t apply(const TinyVector<T1, D> &a,
...
struct OuterProduct<TinyVector<T1, 2>, TinyVector<T2, 2>> {
  ...
  inline static Return_t apply(const TinyVector<T1, 2> &a,
...
struct OuterProduct<TinyVector<T1, 3>, TinyVector<T2, 3>> {
  ...
  inline static Return_t apply(const TinyVector<T1, 3> &a,
                               const TinyVector<T2, 3> &b) {
    return Return_t(a[0] * b[0], a[0] * b[1], a[0] * b[2], a[1] * b[0],
