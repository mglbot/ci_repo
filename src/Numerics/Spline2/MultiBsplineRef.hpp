...
template <typename T>
inline void
MultiBsplineRef<T>::evaluate_v(const spliner_type *restrict spline_m, T x, T y,
                               T z, T *restrict vals,
                               size_t num_splines) const {
...
template <typename T>
inline void
MultiBsplineRef<T>::evaluate_vgl(const spliner_type *restrict spline_m, T x,
                                 T y, T z, T *restrict vals, T *restrict grads,
...
template <typename T>
inline void
MultiBsplineRef<T>::evaluate_vgh(const spliner_type *restrict spline_m, T x,
                                 T y, T z, T *restrict vals, T *restrict grads,
