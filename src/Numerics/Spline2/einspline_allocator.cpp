...
einspline_create_multi_UBspline_3d_s(Ugrid x_grid, Ugrid y_grid, Ugrid z_grid,
                                     ...
                                     int num_splines) {
  // Create new spline
  multi_UBspline_3d_s *restrict spline =
      (multi_UBspline_3d_s *)malloc(sizeof(multi_UBspline_3d_s));
  if (!spline) {
    fprintf(stderr,
...
einspline_create_multi_UBspline_3d_d(Ugrid x_grid, Ugrid y_grid, Ugrid z_grid,
  ...
  multi_UBspline_3d_d *restrict spline =
      (multi_UBspline_3d_d *)malloc(sizeof(multi_UBspline_3d_d));
...
UBspline_3d_d *einspline_create_UBspline_3d_d(Ugrid x_grid, Ugrid y_grid,
                                              ...
                                              double *data) {
  // Create new spline
  UBspline_3d_d *restrict spline =
      (UBspline_3d_d *)malloc(sizeof(UBspline_3d_d));
  spline->spcode = U3D;
  spline->tcode = DOUBLE_REAL;
  spline->xBC = xBC;
  spline->yBC = yBC;
